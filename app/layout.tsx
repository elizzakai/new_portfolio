...
export const metadata = {
  title: 'Elizza | Personal Portfolio',
  description: 'Elizza is a new-grad Developer',
}
  ...
  return (
    <html lang="en" className='!scroll-smooth'> 
      <body className={`${inter.className} bg-gray-50 text-gray-950 relative pt-28 sm:pt-36`}>
        ...
        <div className="bg-[#dbd7fb] absolute top-[-1rem] left-[-35rem] -z-10 h-[31.25rem] w-[50rem] rounded-full blur-[10rem]
