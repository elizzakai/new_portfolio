    ...
    viewport={{once: true,}}>
        ...
        <form className='mt-10 flex flex-col' action={async FormData => {
          ...
          toast.success('Email sent sucessfully!!');
            ...
            <input className='h-14 px-4 rounded-lg borderBlack' name='senderEmail' type="email" required={true} maxLength={500} placeholder='Your email' />
            <textarea className='h-52 my-3 rounded-lg borderBlack p-4' name='message' required={true} maxLength={5000} placeholder='Your message'/>
            <SubmitBtn />
        </form>
    </motion.section>
  )
